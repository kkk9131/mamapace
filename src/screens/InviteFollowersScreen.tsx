...
import { View, Text, FlatList, Pressable, Animated, Alert } from 'react-native';
...
interface InviteFollowersScreenProps {
  ...
  onBack: () => void;
  onInviteSent?: (
    selectedUsers: PublicUserProfile[],
    spaceName: string
  ) => void;
}
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          ...
          >
            ...
            >
              {loading ? 'フォロワーを読み込み中...' : 'フォロワーがいません'}
            </Text>
            {!loading && (
              <Text
                style={{
